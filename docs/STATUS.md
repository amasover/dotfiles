...
| --- | --- | --- | --- |
| 2.1 Classify setup scripts | [#16](https://github.com/amasover/dotfiles/issues/16) | — | In progress |
...
- Privacy pass: work email / `wts-*` refs in public `.gitconfig`/`.profile`/`.zshrc`.
